...
namespace Thatobabusi\LaravelLastFm;

use Thatobabusi\LaravelLastFm\Exceptions\InvalidPeriodException;
...
class Lastfm
{
    ...
    public function period(string $period)
    {
        if (!in_array($period, Constants::PERIODS)) {
            throw new InvalidPeriodException('Request period is not valid. Valid values are defined in \Thatobabusi\LaravelLastFm\Constants::PERIODS.');
        }
